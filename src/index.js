...
toyCollection.addEventListener('click', (e) => {
  ...
  if(e.target.className === "like-btn"){
    // debugger
    let prevLikeValue = parseInt(e.target.previousElementSibling.innerText)
    // debugger
    prevLikeValue = prevLikeValue + 1
    increaseLike(e.target.previousElementSibling, prevLikeValue, e.target.dataset.id)
